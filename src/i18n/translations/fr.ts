const frJSON = {
  ...
  'RiteSchool NextJS Typescript Admin Dashboard':
    "Tableau de bord d'administration de RiteSchool React",
  ...
  'Some of the features that make RiteSchool one of the best admin templates available today':
    "Certaines des fonctionnalités qui font de RiteSchool l'un des meilleurs modèles d'administration disponibles aujourd'hui",
